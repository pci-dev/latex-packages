...
\ifthenelse{\equal{\opendata}{yes}}{\includegraphics[align=c,width=0.5cm]{o_data3.png} \space \large\textbf{\color{pciblue}Open Data}\\}{}
\\
\\
\ifthenelse{\equal{\opencode}{yes}}{\includegraphics[align=c,width=0.5cm]{o_script3.png} \space \large\textbf{\color{pciblue}Open Code\\}}{}
\\
\\
\\
\\
